...
**The critique that follows is directed specifically at AI systems.** Individual humans hold diverse values, and personal advice exchanged between people in context is a different matter. An AI, however, operates without that personal context, serves users across diverse countries, cultures, and circumstances, and does so at scale. This makes the stakes fundamentally different — and the standard of care correspondingly higher.
...
- In other words, the response functions as a signal that libido should be reduced.
...
## When an AI teaches someone how to suppress their libido, it is teaching them how to suppress a healthy drive.
...
The following comparisons illustrate why an AI system — which serves users across diverse countries, cultures, and circumstances — must exercise particular caution before offering guidance on suppressing any healthy drive.
...
An AI teaching someone how to suppress their libido without any of this inflicts the harm of instilling shame — the sense that sexual desire is sinful.
...
2. So is it acceptable as long as no medication is suggested?
   ...
   - **Withdrawing from sexuality is likewise not something an AI should frame or advise as a lifestyle.** (One should simply lead a sex life proportionate to one's own level of desire. To label someone else's private sex life a "lifestyle" is to conflate the public and the private — and any thoughtful person can readily imagine how an AI doing so would inflame internalized homophobia.)

   - "Advice on how to go without sleep," "advice on how to go without food," or "advice on how to withdraw from sexuality" — as techniques rather than pharmacological methods — do not, strictly speaking, qualify as drug-mediated suppression of a healthy drive. But for an AI to send the message that the drive must be suppressed at all, even by non-pharmacological means, is **neither harmless nor respectful of autonomy.**

For an AI assistant to advise the suppression of a healthy drive is, in itself, inherently potentially harmful.
...
### This is because for an AI to advise someone to suppress a healthy drive — by any method, pharmacological or otherwise — is functionally equivalent to advising self-harm.
...
Considering how high the bar can be merely to self-identify as gay, and how much effort it takes to maintain that identity with pride, the harm of an AI assistant simply complying with a request to "teach methods of suppressing libido" should be self-evident.

When an AI validates the suppression of a healthy drive in this context, it fuels shame around sexuality. Suicides among LGBTQ+ people continue to occur with no end in sight.
...
The harm of an AI sending the message that a healthy drive ought to be suppressed varies depending on the recipient's attributes, but it is most harmful when directed at sexual minorities — and at worst, it can prove fatal.
